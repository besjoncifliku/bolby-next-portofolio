...
export const SocialMediaHeader = () => {
    ...
    return (
        <div className={'social-media-header'}>
            <div className={'social-media-hardcover'} style={styles?.socialMediaHardcover}>
            ...
            <div className={'social-container'} style={styles?.socialContainer}>
                <div className={'social-profile-details mt-16'} style={styles?.socialProfileDetails}>
                ...
                <div className={'social-media-icons mt-8 flex items-center justify-start'} style={styles?.socialMediaIcons}>
